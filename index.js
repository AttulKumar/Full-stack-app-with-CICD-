...
const HOSTNAME = 'backend01'
const LBIP = '34.27.61.1' // Replace with your load balancer server IP

// Replace the URL string with your mongodb connection string.
const mongoUrl= 'mongodb://10.10.2.5:27017/';


const client = new MongoClient(mongoUrl);
const db = client.db('database'); // Name of your database
